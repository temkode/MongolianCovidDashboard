				...
				<div className="wrapper-stat-list">
					<div className="stat-list">
						<div className="stat-item confirmed">
							<div className="label">Confirmed <i className="fas fa-viruses"></i></div>
						...
						<div className="stat-item recovered">
							<div className="label">Recovered <i className="fas fa-walking"></i></div>
						...
						<div className="stat-item dead">
							<div className="label">Deceased <i className="fas fa-book-dead"></i></div>
							<div className="count">{isLoaded ? items.deceasedCumulative : "..."}<div className="diff">( {isLoaded ? items.deceased : "..."} )</div></div>
						</div>
						<div className="stat-item active">
							<div className="label">Active <i className="fas fa-procedures"></i></div>
						...
						<div className="stat-item tested">
							<div className="label">Tested <i className="fas fa-vial"></i></div>
